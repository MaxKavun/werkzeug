...
def parse_dict_header(
    value: str, cls: t.Type[dict] = dict
...
def parse_options_header(
    value: str, multiple: "t.Literal[False]" = False
) -> t.Tuple[str, t.Dict[str, t.Optional[str]]]:
    ...


@typing.overload
def parse_options_header(
    value: str, multiple: "t.Literal[True]"
) -> t.Tuple[t.Any, ...]:
    ...
...
@typing.overload
def parse_accept_header(value: str, cls: None = None) -> "ds.Accept":
    ...


@typing.overload
def parse_accept_header(value: str, cls: t.Type[_TAnyAccept]) -> _TAnyAccept:
    ...
